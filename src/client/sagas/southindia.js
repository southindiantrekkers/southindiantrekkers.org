...
export function* initalize() {
  try {
    const get_master_activities = yield callFetch('https://cdn.jsdelivr.net/gh/southindiantrekkers/southindiantrekkers.org@latest/src/client/sagas/modifiedActivities.json');
